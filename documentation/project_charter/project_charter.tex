...
\newcommand{\productname}{Aegis}
\newcommand{\coursename}{CSE 4316: Senior Design I}
\newcommand{\semester}{Fall 2025}
\newcommand{\docname}{Project Charter}
\newcommand{\department}{Department of Computer Science \& Engineering}
\newcommand{\university}{The University of Texas at Arlington}
\newcommand{\authors}{Kevin Farokhrouz \\ Jocelyn Bui \\ Farrukh Hayat \\ Muhammad Khurram \\ Ebenezar Belay \\ Abdulmuizz Wahab}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.95\textwidth]{images/hydra}
\end{figure}
\vspace*{\fill}
...
\begin{versionhistory}
  	\vhEntry{0.1}{9.24.2025}{AW, KF, JB, MK, FH, EB}{document creation}
  	\vhEntry{0.2}{9.28.2025}{AW, KF, JB, MK, FH, EB}{complete draft}
